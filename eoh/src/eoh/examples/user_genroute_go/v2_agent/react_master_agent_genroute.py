...
import react_tools_genroute as react_tools
...
- Knowledge Extraction: If you find promising operator ideas during web_search or read_research_notes, your NEXT step should be to convert them into concrete seeds:
  ...
  - Use add_new_seed to append a new Go GenRoute candidate.
  - CRITICAL: The code for add_new_seed MUST be a complete Go method definition `func (assign *Assign) GenRoute() { ... }`. Do not include package/imports.
...
"""
        ...
        for i in range(max_loops):
            ...
            if not llm_response:
                history.append("Observation: Failed to get a valid response from LLM. Continue.")
                continue
