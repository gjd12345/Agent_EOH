...
def run_code_review(code: str = "", candidate_code: str = "", seed_path: str = "", seed_index: int = 0) -> str:
    ...
    if not code:
        return "FAILED\nNo code provided."
    eva = prob_insertships_go.Evaluation(sim_time_multi=1000000, max_instances=1, run_timeout_s=60)
...
def run_comprehensive_evaluation(sim_time_multi: int = 1000000) -> str:
    ...
    eva = prob_insertships_go.Evaluation(sim_time_multi=int(sim_time_multi), max_instances=8, run_timeout_s=120)
